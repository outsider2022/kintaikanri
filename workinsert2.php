...
if($workplacename=="選択してください") {
  ...
  echo '<a href="' . $_SERVER['HTTP_REFERER'] . '">前に戻る</a>';
    ...
    $stmt2 = $pdo->prepare("UPDATE transaction SET endtime='$endtime',updatedatetime=sysdate(),updated_name=$id where recordID=$recordID;");
    ...
    VALUES (NULL,:workdate,'$endtime',NULL,:empno,:workplacename,NULL,sysdate(),$id,sysdate(),$id);");
